...
import { DistributedTaskSchema, CodeGenerateSchema, TeamCoordinatorSchema, DynamicTeamExpanderSchema, QueryProjectSchema, GitHubManagerSchema, ProjectMetadataSchema, ParallelOptimizerSchema, PerformanceMetricsSchema } from '../types/index.js';
...
export async function setupTools(server) {
    const tools = [];
